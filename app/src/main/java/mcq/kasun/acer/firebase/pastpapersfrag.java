...
public class pastpapersfrag extends Fragment {
    ...
    public static pastpapersfrag newInstance() {

        pastpapersfrag Cat = new pastpapersfrag();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        categories = database.getReference("pastpapers");
