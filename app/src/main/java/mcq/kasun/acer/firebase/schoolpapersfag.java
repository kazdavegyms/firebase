...
public class schoolpapersfag extends Fragment {
    ...
    public static schoolpapersfag newInstance() {

        schoolpapersfag Cat = new schoolpapersfag();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        categories = database.getReference("schoolpappers");
            ...
            viewHolder.setItemClickListner(new ItemClickListner() {
                ...
                public void onClick(View view, int position, boolean isLongClick) {
                 //   Toast.makeText(getActivity(), String.format("%s|%s",adapter.getRef(position).getKey(),model.getName()), Toast.LENGTH_SHORT).show();
                    ...
                    common.pastpapername = model.getName();
